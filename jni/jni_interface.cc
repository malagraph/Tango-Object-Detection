...
JNIEXPORT jfloat JNICALL
Java_com_projecttango_examples_cpp_pointcloud_TangoJNINative_getAverageC(
        JNIEnv*, jobject) {
    return app.GetAverageC();
}

JNIEXPORT jfloat JNICALL
Java_com_projecttango_examples_cpp_pointcloud_TangoJNINative_getClosestPointX(
        JNIEnv*, jobject) {
    return app.GetClosestPointX();
}

JNIEXPORT jfloat JNICALL
Java_com_projecttango_examples_cpp_pointcloud_TangoJNINative_getClosestPointY(
        JNIEnv*, jobject) {
    return app.GetClosestPointY();
}

JNIEXPORT jfloat JNICALL
Java_com_projecttango_examples_cpp_pointcloud_TangoJNINative_getClosestPointZ(
        JNIEnv*, jobject) {
    return app.GetClosestPointZ();
}

JNIEXPORT bool JNICALL
Java_com_projecttango_examples_cpp_pointcloud_TangoJNINative_getObjectInfo(jboolean) {
...
Java_com_projecttango_examples_cpp_pointcloud_TangoJNINative_getTotalPoints(
        JNIEnv*, jobject) {
return 5;//app.GetTotalPoints();
}
