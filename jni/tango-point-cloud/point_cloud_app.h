...
// PointCloudApp handles the application lifecycle and resources.
    ...
    public:
        ...
        float GetAverageZ();
        float GetAverageC();
        float GetClosestPointX();
        float GetClosestPointY();
        float GetClosestPointZ();
    ...
    private:
        ...
        float point_cloud_closest_x_;
        float point_cloud_closest_y_;
        float point_cloud_closest_z_;
        int objectPoints;


        float point_cloud_average_confidence_;
        double tangoTimestamp;
        ...
        tango_point_cloud::Scene main_scene_;
