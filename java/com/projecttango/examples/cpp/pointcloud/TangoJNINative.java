...
public class TangoJNINative {
  ...
  // Get average depth (in meters) in current depth frame.
    ...
    public static native float getClosestPointX();
    public static native float getClosestPointY();
    public static native float getClosestPointZ();
    //public static native long getTotalPoints();
