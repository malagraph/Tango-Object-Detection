...
public class PointcloudActivity extends Activity implements OnClickListener {
  ...
  private TextView xClosest;
  private TextView yClosest;
  private TextView zClosest;
  private TextView totalPoints;

  //private TextView mEdgeCount;
  ...
  protected void onCreate(Bundle savedInstanceState) {
   ...
   // mEdgeCount = (TextView) findViewById(R.id.edge_count);
    ...
    xClosest = (TextView)findViewById(R.id.xClosest_info);
    yClosest = (TextView)findViewById(R.id.yClosest_info);
    zClosest = (TextView)findViewById(R.id.zClosest_info);
    //totalPoints = (TextView)findViewById(R.id.totalPoints_info);


    // Text view for average depth distance (in meters).
    mAverageZ = (TextView) findViewById(R.id.average_depth);
    mAverageC = (TextView) findViewById(R.id.average_confidence);
  ...
  private void updateUi() {
    try {
      ...
      mAverageZ.setText(String.valueOf(TangoJNINative.getAverageZ()));
      mAverageC.setText(String.valueOf(TangoJNINative.getAverageC()));
      xClosest.setText(String.valueOf(TangoJNINative.getClosestPointX()));
      yClosest.setText(String.valueOf(TangoJNINative.getClosestPointY()));
      zClosest.setText(String.valueOf(TangoJNINative.getClosestPointZ()));
      //totalPoints.setText(String.valueOf(TangoJNINative.getTotalPoints()));
      // mEdgeCount.setText(String.valueOf(TangoJNINative.getEdgeCount()));
    } catch (Exception e) {
      e.printStackTrace();
